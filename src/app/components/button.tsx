...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ children, disabled, className = '', variant, ...props }, ref) => {
    const base =
      'relative flex items-center justify-center w-full md:w-[320px] xl:w-[244px] 3xl:w-[300px]  h-[60px] py-2 px-5 rounded-md text-black text-base xl:text-lg font-medium transition-all duration-200 outline-none group';
